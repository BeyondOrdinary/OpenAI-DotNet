    ...
    internal sealed class JsonStringEnumConverter<TEnum> : JsonConverter<TEnum> where TEnum : struct, Enum
    {
        ...
        public JsonStringEnumConverter()
        {
            ...
            foreach (var value in Enum.GetValues(typeof(TEnum)))
            {
                ...
                {
                    numberToEnum.Add(index, (TEnum)value);
                    enumToString.Add((TEnum)value, attribute.Value);
                    stringToEnum.Add(attribute.Value, (TEnum)value);
                }
                else
                {
                    var convertedName = namingPolicy != null
                        ...
                        : value.ToString();
                    numberToEnum.Add(index, (TEnum)value);
                    enumToString.Add((TEnum)value, convertedName);
                    stringToEnum.Add(convertedName, (TEnum)value);
                }
            }
        }
